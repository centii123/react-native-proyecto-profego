        ...
        <View className="flex-1">
            ...
            <ScrollView >
                <View className="flex-1 relative">
                    ...
                    <View className="flex-1 absolute right-4 top-28 justify-center items-center">
                        ...
                        <Link href={'/register-student'} className="text-lg bg-orange-500 border-white border-2 w-40 py-1 text-center text-slate-50 mb-3 rounded-xl">
                            Estudiante
                        </Link>
                    </View>
                </View>
                <View className="items-center">
                    ...
                    <Link href={'/'} className="py-2 mt-10 mb-48 w-72 rounded-2xl justify-center items-center bg-blue-600 text-center">
