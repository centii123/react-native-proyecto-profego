            ...
            <ScrollView >
                ...
                <View className="mt-8">
                    <Link href={'/'} className=" border-orange-500 border-2 mx-3 rounded-lg py-4 mt-5">
                        <View className="mx-5 flex-row justify-around items-center w-96 ">
                            <View className="flex-row items-center" style={{ width: 250 }}>
                                <Image source={uno} resizeMethod="contain" style={{ width: 45 }} />
                    ...
                    <Link href={'/'} className=" border-orange-500 border-2 mx-3 rounded-lg py-4 mt-5">
                        <View className="mx-5 flex-row justify-around items-center w-96 ">
                            <View className="flex-row items-center" style={{ width: 250 }}>
                                <Image source={dos} resizeMethod="contain" style={{ width: 45 }} />
                    ...
                    <Link href={'/'} className=" border-orange-500 border-2 mx-3 rounded-lg py-4 mt-5">
                        <View className="mx-5 flex-row justify-around items-center w-96 ">
                            <View className="flex-row items-center" style={{ width: 250 }}>
                                <Image source={tres} resizeMethod="contain" style={{ width: 45 }} />
                    ...
                    <Link href={'/'} className=" border-orange-500 border-2 mx-3 rounded-lg py-4 mt-5">
                        <View className="mx-5 flex-row justify-around items-center w-96 ">
                            <View className="flex-row items-center" style={{ width: 250 }}>
                                <Image source={cuatro} resizeMethod="contain" style={{ width: 45 }} />
                    ...
                    <Link href={'/'} className=" border-orange-500 border-2 mx-3 rounded-lg py-4 mt-5">
                        <View className="mx-5 flex-row justify-around items-center w-96 ">
                            <View className="flex-row items-center" style={{ width: 250 }}>
                                <Image source={cinco} resizeMethod="contain" style={{ width: 45 }} />
                    ...
                    <Link href={'/'} className=" border-orange-500 border-2 mx-3 rounded-lg py-4 mt-5">
                        <View className="mx-5 flex-row justify-around items-center w-96 ">
                            <View className="flex-row items-center" style={{ width: 250 }}>
                                <Image source={seis} resizeMethod="contain" style={{ width: 45 }} />
                    ...
                    <Link href={'/'} className=" border-orange-500 border-2 mx-3 rounded-lg py-4 mt-5">
                        <View className="mx-5 flex-row justify-around items-center w-96 ">
                            <View className="flex-row items-center" style={{ width: 250 }}>
                                <Image source={siete} resizeMethod="contain" style={{ width: 45 }} />
                    ...
                    <Link href={'/'} className=" border-orange-500 border-2 mx-3 rounded-lg py-4 mt-5">
                        <View className="mx-5 flex-row justify-around items-center w-96 ">
                            <View className="flex-row items-center" style={{ width: 250 }}>
                                <Image source={ocho} resizeMethod="contain" style={{ width: 45 }} />
                    ...
                    <Link href={'/'} className=" border-orange-500 border-2 mx-3 rounded-lg py-4 mt-5">
                        <View className="mx-5 flex-row justify-around items-center w-96 ">
                            <View className="flex-row items-center" style={{ width: 250 }}>
                                <Image source={nueve} resizeMethod="contain" style={{ width: 45 }} />
                    ...
                    <Link href={'/'} className=" border-orange-500 border-2 mx-3 rounded-lg py-4 mt-5">
                        <View className="mx-5 flex-row justify-around items-center w-96 ">
                            <View className="flex-row items-center" style={{ width: 250 }}>
                                <Image source={diez} resizeMethod="contain" style={{ width: 45 }} />
