...
const principalImg = require('../../assets/loginDocente.png')
    ...
    <View>
      <ScrollView>
        <View className="flex-1 justify-between min-h-screen">
          ...
          <View className="absolute right-4 top-28 justify-center items-center">
            <Text className="text-2xl w-40 text-center text-white mb-3">Soy</Text>
            <Text className="text-lg bg-white border-orange-500 border-2 w-44 py-1 text-center mb-3 rounded-xl">
              Docente o coach
            </Text>
            <Link href={'/login-student'} className="text-lg bg-orange-500 border-white border-2 w-40 py-1 text-center text-slate-50 mb-3 rounded-xl">
              Estudiante
            </Link>
          </View>
          <View className="items-center">
            ...
            <Link href={'/docente/registro-datos'} className="py-2 mt-4 w-72 rounded-2xl justify-center items-center bg-orange-500 text-center">
          ...
          <View className="relative justify-center items-center">
            ...
            <Text className="absolute text-green-700">¿No tienes una cuenta? <Link href={'/register-teacher'} className="text-orange-500">
              Regístrate aquí
            </Link> </Text>
          </View>
