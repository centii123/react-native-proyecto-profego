            ...
            <ScrollView>
                <View className="flex-1 justify-between min-h-screen">
                    ...
                    <View className="absolute right-4 top-28 justify-center items-center">
                        ...
                        <Link href={'/login-teacher'} className="text-lg bg-blue-600 border-white border-2 w-40 py-1 text-center text-slate-50 mb-3 rounded-xl">
                            Docente o coach
                        </Link>
                    </View>
                    <View className="items-center">
                        ...
                        <Link href={'/estudiante/inicio'} className="py-2 mt-4 w-72 rounded-2xl justify-center items-center bg-orange-500 text-center">
