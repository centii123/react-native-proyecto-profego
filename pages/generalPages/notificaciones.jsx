            ...
            <ScrollView className="min-h-full">
                ...
                <View className="mt-5 mb-10">
                    <View className="mx-2 px-2 py-2 rounded-lg mb-3 border-orange-500 border-2 flex-row items-center">
                        <Image source={logoMensaje} style={{ width: 60, height: 60 }} className="mr-4 ml-1"/>
                        <View >
                            <Text className="text-xl mb-3 w-72 text-orange-700">Titulo de la notificacion </Text>
                            <Text className="text-slate-700 mb-1">Publicacion: 07-08-2001  13:30</Text>
                            <Text className="w-72">Descripcion de la notificacion gdfgfdgdfgdf gdf gdfg dfg dfg dfg dfg dfg dfg dfg dfg dfg fd gdfg dfg dfgdf gdf gdfg dfg dfg dfg dfg dfg</Text>
                        </View>
