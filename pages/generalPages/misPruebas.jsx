...
export function MisPruebasPage() {
    ...
    return (
        <View className="flex-1">
            ...
            <Text className="text-center text-2xl font-bold mt-20 mx-3 text-blue-500">Mis Pruebas</Text>
            ...
            <ScrollView className="min-h-screen">
                ...
                <View className="flex-row flex-wrap gap-1 justify-center mt-2">
                    ...
                    onPress={() => setIsVisible(!isVisible)}
                     className="bg-white shadow-lg rounded-lg p-1 border-orange-500 border-2" style={{ width: containerWidth }}>
                        <View className=" items-center">
                            <Text className="text-lg  mt-2 text-blue-700">Prueba de ingles</Text>
                            <View className="my-1 justify-center">
                                <Text>Fecha: 02-01-2001</Text>
                                <Text className="text-base">
                                    Calificación: <Text className="text-green-600">80/100</Text>
                                </Text>
                            </View>
                    ...
                    underlayColor={'#F0C491'}
                    onPress={() => setIsVisible(!isVisible)}
                    className="bg-white shadow-lg rounded-lg p-1 border-blue-500 border-2" style={{ width: containerWidth }}>
                        <View className=" items-center">
                            <Text className="text-lg  mt-2 text-blue-700">Prueba de ingles</Text>
                            <View className="my-1 justify-center">
                                <Text>Fecha: 02-01-2001</Text>
            ...
            {/* Modal */}
            <View className={`${isVisible ? '' : 'hidden'} absolute h-96 bg-white border-2 border-orange-500 rounded-lg top-28`} style={{marginLeft:Dimensions.get('window').width * 0.03}}>
                <View className="flex-row justify-between items-center mx-4">
                    <View className="flex-row items-center">
                        <Text className="text-center text-2xl text-orange-700 my-3">Prueba</Text>
                    </View>
                    ...
                    >
                        <Text className="text-2xl text-red-700">x</Text>
                    </TouchableHighlight>
                ...
                <ScrollView>
                    ...
                    <Text className="mx-4 mt-3">Fecha: 01-02-2001</Text>
                    <Text className="mx-4">Calificacion: <Text className="text-green-500">80/100</Text></Text>
